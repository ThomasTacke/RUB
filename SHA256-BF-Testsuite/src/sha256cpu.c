...
void sha256(char* input, uint32_t input_length, uint8_t sha256sum[32]) {
	sha256_context ctx;

	sha256_starts(&ctx);
	sha256_update(&ctx, (uint8_t *) input, input_length);
...
void sha256comp_cpu(char* input, uint32_t input_length, uint8_t* sha256sum) {
	sha256(input, input_length, sha256sum);
}
